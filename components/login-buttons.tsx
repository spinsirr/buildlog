...
export function LinkedInLoginButton() {
  return (
    <button
      ...
      className="w-full flex items-center justify-center gap-3 bg-[#0A66C2] text-white border-4 border-black font-mono font-bold text-sm uppercase tracking-widest py-4 cursor-pointer neo-btn focus-visible:ring-2 focus-visible:ring-black focus-visible:ring-offset-2 focus-visible:outline-none"
      style={{ fontFamily: 'var(--font-ibm-plex-mono)' }}
    >
      <svg viewBox="0 0 24 24" className="h-5 w-5 fill-current shrink-0" aria-hidden>
